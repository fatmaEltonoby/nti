  ...
  <div class="container">
          <div class="row ">
              ...
              <div class="col-4 offset-4 mt-5">
                <form method="POST">
                  <input type="numeric" name="num1" class="col-12 " placeholder=" enter the first number">
                  <input type="numeric" name="num2" class="col-12 mt-3 " placeholder=" enter the second number">
